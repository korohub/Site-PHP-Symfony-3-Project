...
class AfterLoginRedirection implements AuthenticationSuccessHandlerInterface
{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token)
    {
        ...
        } elseif (in_array('ROLE_SALARIE', $rolesTab, true)){
            // c'est un utilisaeur salarie: on le rediriger vers salarie
            $redirection = new RedirectResponse($this->router->generate('salarie'));
        } else {
